...
<head>
    ...
    <title>Sign Up - Travel Archives</title>
...
<body class="min-h-screen flex items-center justify-center text-white">
    <div class="max-w-md w-full px-6 py-12">
        ...
        <div class="card rounded-3xl p-10 shadow-2xl">
            <h1 class="title-font text-4xl font-bold text-center mb-2">Join the Journey</h1>
            <p class="text-center text-white/70 mb-8">Create your Travel Archives account</p>
            ...
            <p class="text-center mt-8 text-white/70">
                Already have an account? <a href="login.php" class="font-semibold hover:underline">Sign In</a>
            </p>
        </div>
